...
| **Accounts Assistant**               | `Accounts Assistant`               | `Accounts Assistant`                   | Tracks installation milestone completion against customer billing schedule and contractual advance terms.                                                          |
...
| **`Accounts Assistant`**           |             Read Only              |       Read Only        |            Read Only             |               Read Only                |            Read Only             | Audit Milestone Progress for Billing Milestones  |
