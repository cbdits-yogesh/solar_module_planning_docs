...
| **Site Technical Requisitioner**   | `Project Engineer`   | Engineering Operations | `Site Supervisor`             | Receives direct-to-site equipment, captures GPS lock, uploads transporter LR/Challan, verifies physical condition, submits Site PR.     |
| **Solar Project Manager**          | `Project Manager`    | Engineering Operations | `Senior Project Manager`      | Reviews and authorizes Site Warehouse Entry Requests raised by Purchase PRs, physically verifying equipment arrival on site.            |
...
| **Site Quality & Audit Inspector** | `Quality Engineer`   | Quality Assurance      | `QA/QC Engineer`              | Inspects solar panel EL test certificates, validates flash reports, documents transit defects and signs off rejection reasons.          |
| **Finance & Accounts Head**        | `Accounts Assistant` | Finance & Accounts     | `Accounts Officer`            | Ingests approved GRN into Step 17 3-way invoice matching; prepares Step 18 milestone payment release.                                   |
