...
| :-----: | :---------------------------------------------------------------------- | :---------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------ | :--------------------: |
| **01**  | **Lead Capture, Deduplication & Survey Scheduling**                     | [`ADR-001`](../decisions/ADR-001-LEAD-MANAGEMENT-DEDUPLICATION-ROUTING.md)                | [`STEP_01`](../../step_plans/STEP_01_LEAD_MANAGEMENT_SPECIFICATION.md)                  | [`STEP_01.caveman`](../../step_plans_for_ai/STEP_01_LEAD_MANAGEMENT_SPECIFICATION.caveman.md)                  | `codes/client_script/lead.js`, `lead_listview.js`                                             | `tabLead`, `LeadValidationService`, `LeadSLAService`, `SiteSurveyBridgeService`                                                                   | **Reconciled & Ready** |
...
- **Document References:** [`ADR-001`](../decisions/ADR-001-LEAD-MANAGEMENT-DEDUPLICATION-ROUTING.md) | [`STEP_01`](../../step_plans/STEP_01_LEAD_MANAGEMENT_SPECIFICATION.md) | [`STEP_01.caveman`](../../step_plans_for_ai/STEP_01_LEAD_MANAGEMENT_SPECIFICATION.caveman.md)
...
- **Audit Verification:** ✔ Schema complete | ✔ State machine defined | ✔ SOLID services decoupled | ✔ Tests defined (zero DB commit).
