...
| **Technical Quality Lead**  | **`Store Manager`** / **`Project Engineer`** | `Store Manager` / `Project Engineer` | `Warehouse / Field Technical Lead` | Read / Write (Quality logs)       | Reviews physical GRN inspection records, enters technical test logs (flash tests, EL, MTCs), and verifies defect classifications.                             |
| **Procurement Line**        | **`Purchase Assistant`**                     | `Purchase Assistant`                 | `Purchase Executive`               | Read Only                         | Monitors vendor scores, attaches communication histories, and drafts initial scorecard records.                                                               |
...
| **Finance Department Lead** | **`Accounts Manager`**                       | `Accounts Manager`                   | `Finance Head / Controller`        | Read Only                         | Provides underlying 3-way match variance records, debit notes, and payment settlement turnaround logs.                                                        |
