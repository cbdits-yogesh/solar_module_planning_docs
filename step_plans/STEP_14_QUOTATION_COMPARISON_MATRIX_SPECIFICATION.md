...
| **Site Technical Requisitioner**   | `Project Engineer` / `Site Supervisor` | Engineering Operations | `Field Engineer / Supervisor` | Reviews technical deviations in supplier quotes (datasheets, cable ratings, inverter warranties) against design specs.               |
